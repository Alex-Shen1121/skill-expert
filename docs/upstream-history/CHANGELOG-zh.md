# 上游 Skills Manager 更新日志（归档）

本文件是上游 `xingkongliang/skills-manager` 项目的历史归档。
它只用于保留来源记录，不属于 Skill Expert 的独立发布线。

上游项目：<https://github.com/xingkongliang/skills-manager>

# Upstream Skills Manager Changelog (Archived)

This file is the archived history of the upstream `xingkongliang/skills-manager` project.
It is retained for provenance only and is not part of the independent Skill Expert release line.

Upstream project: <https://github.com/xingkongliang/skills-manager>

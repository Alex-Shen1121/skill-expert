...
- **Standalone CLI downloads join every release** — Release assets now include `skills-manager-cli` binaries for macOS arm64/x64, Windows x64, and Linux x64. The macOS binaries are Developer ID signed, notarized, and Gatekeeper-checked like the desktop app.

...
fn build_tray_menu_from_data<R: tauri::Runtime>(
    ...
    let app_name = MenuItem::with_id(app, "tray-app-name", "Agent 技能管家", false, None::<&str>)?;
    ...
    let show_item = MenuItem::with_id(app, "show", "Open Agent 技能管家", true, None::<&str>)?;
...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::agent_plugins::reset_codex_cli_path,
            // Tools
            ...
            commands::skills::prepare_skill_browser_source,
            commands::skills::get_skill_browser_diff,
